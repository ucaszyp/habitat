...
def get_args():
    ...
    parser.add_argument('--num_sem_categories', type=float, default=42)
    ...
    parser.add_argument("--sem_gt", type=int, default=0)
    parser.add_argument("--player", type=int, default=0)
    parser.add_argument("--random", type=int, default=0)
    parser.add_argument("--save_np", type=int, default=0)
    parser.add_argument("--get_bird", type=int, default=0)
    parser.add_argument("--classes", type=int, default=41)
    # parse arguments
