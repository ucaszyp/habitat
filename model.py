...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.screen_h = args.frame_height #observation img height
        self.screen_w = args.frame_width
        self.resolution = args.map_resolution
        self.z_resolution = args.map_resolution
        self.map_size_cm = args.map_size_cm // args.global_downscaling
        self.n_channels = 3
        self.vision_range = args.vision_range #100
        self.dropout = 0.5
        self.fov = args.hfov #horizontal field of view in degree
        ...
        self.agent_height = args.camera_height * 100. # 88cm
    ...
    def forward(self, obs, pose_obs, maps_last, poses_last):
        ...
        # Transforms the point cloud into geocentric frame to account for camera elevation and angle
